...
from app.import_process.agent.nodes.node_normalize_to_md import node_normalize_to_md
from app.import_process.agent.nodes.node_paper_item_name_recognition import (
    node_paper_item_name_recognition,
)
...
workflow.add_node("node_normalize_to_md", node_normalize_to_md)
workflow.add_node("node_md_img", node_md_img)
workflow.add_node("node_document_split", node_document_split)
workflow.add_node("node_item_name_recognition", node_paper_item_name_recognition)
...
def route_after_entry(state: ImportGraphState) -> str:
    ...
    if state.get("is_md_read_enabled"):
        return "node_md_img"
    if state.get("is_normalize_to_md_enabled"):
        return "node_normalize_to_md"
    return END
...
workflow.add_conditional_edges(
    ...
    route_after_entry,
    {
        ...
        "node_normalize_to_md": "node_normalize_to_md",
        END: END,
    },
)

workflow.add_edge("node_pdf_to_md", "node_md_img")
workflow.add_edge("node_normalize_to_md", "node_md_img")
